                    ...
                    <form class="form" action="{{route('task.create')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input class="form-control @error('title') invalid-feedback @enderror" name="title" id="title" type="text" required placeholder="Enter Title">
                                @error('title')
                        ...
                        <div class="row my-3">
                            <div class="col-6">
                                ...
                                <input class="form-control @error('priority') invalid-feedback @enderror"
                                       id="priority" name="priority" type="number" min="1" required placeholder="Enter Priority">
                                @error('priority')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
